        ...
        <div class="modal-content">
            <div class="modal-header">
                <c:if test="${empty item.id}">
                    <h5 class="modal-title" id="exampleModalLongTitle"><fmt:message key="label.actor.add"
                                                                                    bundle="${lang}"/></h5>
                </c:if>
                <c:if test="${not empty item.id}">
                    <h5 class="modal-title" id="exampleModalLongTitle"><fmt:message key="label.actor.update"
                                                                                    bundle="${lang}"/></h5>
                </c:if>
                ...
                <form:form action="" id="formSubmit" cssClass="form-horizontal" modelAttribute="item">
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="code" class=" form-control-label"><fmt:message
                                bundle="${lang}" key="label.actor.code"/> </label>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="name" class=" form-control-label"><fmt:message
                                bundle="${lang}" key="label.actor.name"/> </label>
                        </div>
                        <div class="col-12 col-md-9">
